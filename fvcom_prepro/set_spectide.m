...
%        equilibrium_amp = equilibrium amplitudes of tides at the open boundary nodes
...
%------------------------------------------------------------------------------
% Setup user defined phase and amplitude along the open boundaries need to set:
